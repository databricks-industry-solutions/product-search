...
# MAGIC %md The purpose of this notebook is to provide access to configuration data used by the Product Search solution accelerator.  This notebook was developed on a **Databricks ML 12.2 LTS GPU** cluster.
